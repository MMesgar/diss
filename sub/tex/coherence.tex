...
In some literature in text linguistics, e.g.\ \newcite{halliday76}, this phenomena is referred to as cohesion.   
\newcite{stoddard91} (Chapter 2, page??) argues that these two are not distinguishable and can be used interchangeably. 
...
\newcite{halliday76} summarize it in this way that ``given information'' has been talked about in a text and ``new information'' is been mentioning now.  
...
\newcite{danes74} explains that ``given information'' can be realized either directly with an identical wording or , indirectly, with a synonymous expression, or with a paraphrase. 

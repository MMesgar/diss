...
We show that our patterns are almost similar to the patterns introduced by \newcite{danes74a}. 
...
So they are expected to better distinguish texts.  
...
Although this pattern is useful, if it occurs too frequently in a document then it disturbs the coherence of the document. 

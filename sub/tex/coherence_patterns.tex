...
We employ the summarization proposed by \newcite{parveen15} as it is based on the entity graph model (see Chapter \ref{ch:rel-work}), the same frame work as our coherence model

...
It does not extract any pattern but it makes a strong assumption about the set of all relations among sentences in a text: Bigger the relation set among sentences is, more coherent the text is. 
...
So their frequencies are expected to better distinguish texts.  
...
\newcite{parveen15a} assume that the outdegree of a node in the projection graph of an input text measures how crucial its corresponding sentence is for the coherence of the summary.  
...
The above constrains check whether the pattern is an induced subgraph of the projection graph. 

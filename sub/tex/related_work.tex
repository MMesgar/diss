...
Moreover, the relationships among sentences of easy-to-read texts are easy to recognize and interpret for readers, and therefore information smoothly moves sentence by sentence as the text progresses. 
...
\newcite{pitler08} evaluate the features proposed by the entity grid model and other discourse features such as the frequency obtained based on the RST relations by comparing their performance for the readability assessment task. 

...
\newcite{guinaudeau13} propose to transfer entity graphs to a graph whose nodes capture only sentences and whose relations encode entity-based connections among sentences. 
...
\newcite{guinaudeau13} define a coherence metric based on the assumption that projection graphs of coherent texts contain more edges than projection graphs of incoherent ones.  
...
\newcite{halliday76} stress the role of lexical cohesion in text coherence. 
...
The third trend of research related to lexical cohesion uses the probabilistic models to assign a coherence score to a text. 
